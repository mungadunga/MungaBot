module.exports = {
    ...
    execute(message, args){ 
        ...
        .setDescription(`__Release date of MungaBot's versions:__
        MungaBot v1.0.0: 23.06.20 (first version of mungabot, only had >sup and >version)
        ...
        MungaBot v6.0.0: 18.11.20 (redesigned >info and added multiple info commands, and switched prefix from / to >)
        `);
